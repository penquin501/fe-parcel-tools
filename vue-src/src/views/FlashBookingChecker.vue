<template>
  <div>
    ...
    <h1>รายการ booking flash: {{ dateFormat(form.selectDate) }}</h1>
    <el-table :data="filteredResources" style="width: 100%" height="500">
        ...
        <el-table-column prop="reason_code" label="reason_code"></el-table-column>
        <el-table-column prop="reason_th" label="reason_th"></el-table-column>
...
export default defineComponent({
  ...
  methods: {
    ...
    setStore(row: any) {
      //@ts-ignore
      this.$store.commit("flashBooking", row);
      this.$router.push({ name: "FlashBookingDetail" });
    },
